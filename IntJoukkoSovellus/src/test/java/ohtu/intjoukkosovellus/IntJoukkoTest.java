...
public class IntJoukkoTest {
    ...
    public void lukujaLisattyMaara() {
        joukko.lisaa(4);
        assertEquals(3, joukko.getLukumaara());
    }
    ...
    public void samaLukuMeneeJoukkoonVaanKerran() {
        joukko.lisaa(10);
        joukko.lisaa(3);
        assertEquals(2, joukko.getLukumaara());
    }
    ...
    public void poistettuEiOleEnaaJoukossa() {
        ...
        assertEquals(1, joukko.getLukumaara());
    }
    ...
    public void toimiiKasvatuksenJalkeen(){
        ...
        assertEquals(14, joukko.getLukumaara());
        assertTrue(joukko.kuuluu(11));
        joukko.poista(11);
        assertFalse(joukko.kuuluu(11));
        assertEquals(13, joukko.getLukumaara());
    }
